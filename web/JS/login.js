<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['usr']) && isset($_POST['pwd'])) {
        ...
        $conn = getConnection();
        $stmt = $conn->prepare("SELECT username, password FROM user4 WHERE username = ?");
    ...
    <main class="w3-panel w3-cell-row">
        ...
        <div class="w3-cell w3-card-4 w3-border w3-round-large" style="width: 40%">
            <form class="w3-panel" action="#" method="POST">
                ...
                <p>
                    <a href="#" class="w3-mobile" id="register-link">Create an account?</a>
                </p>
            </form>
            <div id="register-form" style="display: none;">
                <p>
                    <input class="w3-input" placeholder="Email" id="register-email" required>
                </p>
                <p>
                    <input class="w3-input" type="password" placeholder="Password" id="register-password" required>
                </p>
                <p>
                    <button class="w3-input w3-button w3-blue w3-round" id="register-button">Register</button>
                </p>
